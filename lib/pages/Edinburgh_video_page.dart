...
class _EdinburghVideoPageState extends State<EdinburghVideoPage> {
        ...
        child: OrientationBuilder(
          ...
          if (orientation != Orientation.landscape) {
            return Scaffold(
              ...
              body: Center(child: YoutubeEdinBurghPlayer()),
            );
          } else {
            return Scaffold(
              body: YoutubeEdinBurghPlayer(),
            );
          }
        }),
      ),
  ...
  // The YoutubeEdinBurghPlayer build a player that plays the video
  Widget YoutubeEdinBurghPlayer() {
    return Container(
      child: YoutubePlayer(
